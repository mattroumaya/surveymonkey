...
*Developer's note: That's how a user can get a single account's OAuth token.  It might be preferable if users could authenticate from with R.  If someone has guidance for how users should obtain their OAuth token more generally, please submit a pull request or comment in an issue.*
